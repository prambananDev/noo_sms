...
class PreviewEditController extends GetxController {
  late final CustomerDetailFormController customerFormController;

  @override
  void onInit() {
    super.onInit();
    customerFormController = Get.find<CustomerDetailFormController>();
  }
